// generate-mcq.// generate-mcq.js — MedBoard Pro
...
function buildPrompt(level, requestedTopic) {
  ...
  var systemText =
    ...
    "- NEXT BEST STEP questions: a decision point where the right move requires understanding pathophysiology and clinical context\n" +
