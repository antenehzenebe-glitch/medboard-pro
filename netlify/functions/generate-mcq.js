...
- NON-STATIN ESCALATION is by MAGNITUDE of the LDL gap to goal, NOT a fixed ladder: ezetimibe ~18-20%, bempedoic acid + ezetimibe ~38% (~moderate-intensity statin), PCSK9 mAb (evolocumab/alirocumab) ~60%. When the gap is too large for orals to reach goal (HeFH / very-high-risk with LDL far above target; orals cannot close a >40-50% gap) -> key a PCSK9 mAb, added alongside ezetimibe (not after sequentially failing it). Bempedoic acid = statin-intolerant branch OR already near goal / injectable access limited; NOT the answer for a large gap. Inclisiran (siRNA; 0 and 3 mo, then q6mo): 2026 ACC/AHA notes CV-outcomes data still pending -> do NOT key over a PCSK9 mAb. HoFH -> evinacumab (+/- lomitapide).
...
6. COGNITIVE LEVEL:
  ...
  { keywords: ["lipid", "dyslipidemia", "cholesterol", "statin", "ascvd", "pcsk9", "ezetimibe", "triglyceride", "lpa", "lp(a)", "familial hypercholesterolemia", "bempedoic", "inclisiran", "fenofibrate"], citation: `2026 ACC/AHA/Multisociety Guideline on the Management of Dyslipidemia (Blumenthal RS, Morris PB, Gaudino M, et al.; JACC 2026, doi:10.1016/j.jacc.2025.11.016; copublished Circulation 2026) — RETIRES & REPLACES the 2018 Blood Cholesterol Guideline; AACE 2025 CPG on Pharmacologic Management of Adults with Dyslipidemia (Patel SB, Wyne KL, Endocr Pract 2025;31:236-262); 2022 ACC Expert Consensus Decision Pathway on Non-Statin Therapies (Lloyd-Jones et al.).
...
4. NON-STATIN ESCALATION — choose by MAGNITUDE of the LDL gap to goal, NOT a fixed ladder: ezetimibe ~18-20%; bempedoic acid + ezetimibe ~38% (~moderate-intensity statin); PCSK9 mAb (evolocumab/alirocumab) ~60%. Gap too large for orals to reach goal (HeFH or very-high-risk with LDL far above target; orals cannot close a >40-50% gap) -> KEY a PCSK9 mAb, added alongside (not after sequentially failing) ezetimibe. Bempedoic acid = statin-intolerant branch OR near goal / injectable access limited; NOT for a large gap. Inclisiran (siRNA; 0 and 3 mo, then q6mo): 2026 ACC/AHA notes CV-outcomes data still pending -> do NOT key over a PCSK9 mAb. HoFH -> evinacumab (+/- lomitapide). AACE 2025: niacin NOT recommended as add-on in hypertriglyceridemia 150-499 with/at risk of ASCVD.
...
const TOPIC_DISTRIBUTION = {
  ...
  "USMLE Step 1": [
    { topic: "Cardiovascular pathology (atherosclerosis, ischemia, vasculitis)", weight: 3 },
    { topic: "Respiratory pathology (obstructive/restrictive, edema, embolism)", weight: 3 },
    { topic: "Renal and genitourinary pathology", weight: 3 },
    { topic: "Gastrointestinal and hepatic pathology", weight: 3 },
    { topic: "Hematologic and oncologic pathology", weight: 4 },
    { topic: "Endocrine and reproductive pathology", weight: 3 },
    { topic: "Neoplasia — general principles (carcinogenesis, tumor markers, staging)", weight: 2 },
    { topic: "Inflammation, tissue repair, and cell injury", weight: 3 },
    { topic: "Cardiovascular physiology (pressure-volume, baroreflex, Starling)", weight: 3 },
    { topic: "Renal physiology and acid-base", weight: 3 },
    { topic: "Respiratory physiology (gas exchange, V/Q, mechanics)", weight: 2 },
    { topic: "Endocrine physiology (feedback axes)", weight: 2 },
    { topic: "Metabolic biochemistry — carbohydrate, glycogen, gluconeogenesis", weight: 3 },
    { topic: "Metabolic biochemistry — lipid and fatty-acid oxidation", weight: 2 },
    { topic: "Amino acid, urea cycle, and inborn errors of metabolism", weight: 3 },
    { topic: "Vitamins and cofactors (deficiency biochemistry)", weight: 2 },
    { topic: "Autonomic pharmacology (cholinergic/adrenergic)", weight: 3 },
    { topic: "Cardiovascular and renal pharmacology", weight: 3 },
    { topic: "CNS and psychiatric pharmacology", weight: 2 },
    { topic: "Antimicrobial, antiviral, and antineoplastic pharmacology", weight: 3 },
    { topic: "Pharmacokinetics and pharmacodynamics", weight: 2 },
    { topic: "Toxicology and overdose/antidotes", weight: 3 },
    { topic: "Bacteriology (mechanisms, exotoxins, gram-pos/neg)", weight: 3 },
    { topic: "Virology (replication, oncogenic, latency)", weight: 3 },
    { topic: "Mycology and parasitology", weight: 2 },
    { topic: "Immunology — innate and complement", weight: 2 },
    { topic: "Immunology — adaptive (T/B cell, MHC, hypersensitivity)", weight: 3 },
    { topic: "Immunodeficiency and HIV/opportunistic infection", weight: 3 },
    { topic: "Neuroanatomy — brainstem, tracts, lesion localization", weight: 3 },
    { topic: "Neuroanatomy — cranial nerves and special senses", weight: 2 },
    { topic: "Gross anatomy — limbs and peripheral nerves", weight: 2 },
    { topic: "Gross anatomy — thorax, abdomen, pelvis", weight: 2 },
    { topic: "Embryology — organ-system development and malformations", weight: 3 },
    { topic: "Biostatistics — study design, bias, and test characteristics", weight: 4 },
    { topic: "Epidemiology and population health", weight: 2 },
    { topic: "Behavioral science, development, and medical ethics", weight: 2 },
    { topic: "Inheritance patterns and population genetics", weight: 2 },
    { topic: "Molecular biology and single-gene/chromosomal disorders", weight: 2 },
  ],
  "USMLE Step 2 CK": [
...
// ============================================================
// CANON-ALIGNED VALIDATORS (v7.5.6) — ABIM/NBME source-grounded
// ============================================================
