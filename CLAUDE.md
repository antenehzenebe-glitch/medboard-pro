...
3. **USMLE — pending backlog cleared 2026-06-06; still below threshold.** Step 1 36 / Step 2 CK 27 / Step 3 28 (targets ~150–180). The 34-row legacy backlog was triaged (all promoted after diversifying repeated Step 1 stems + HCAP/previa edits). **Priority: staged generation** (round-robin or per-level, count 20–30, vet each batch) to climb toward threshold.
