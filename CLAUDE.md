...
| USMLE Step 1 | 54 | ~150 | ~96 |
| USMLE Step 2 CK | 49 | ~180 | ~131 |
| USMLE Step 3 | 43 | ~150 | ~107 |
| **Total servable** | **522** | | |
...
7. **Promote `flagCardiorenalMiskey` to hard-reject** — ≥2 clean warn-mode batches now on record (the 2026-06-06 IM + USMLE batches produced 0 cardiorenal warns, with correct SGLT2i keying in `1cd0de2d`/`355a9d1d`/`d99b0afe`). Promotion to hard-reject can now be considered. Also build sibling `flagT1DCardiorenal`.
...
### USMLE generation hardening (proposed — not yet built; the 2026-06-06 evidence)
